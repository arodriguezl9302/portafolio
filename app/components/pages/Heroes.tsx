  ...
  return (
    <section className="mt-32 max-w-5xl">
      ...
      <ul className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-6 mt-12 tracking-tight">
        <li className="flex items-center gap-x-2 dark:bg-primary-bg bg-zinc-100 border dark:border-zinc-800 border-zinc-200 rounded-md px-2 py-1">
          <EasterEgg isMet={true} />
          <a
            href="url"
            rel="noreferrer noopener"
            target="_blank"
            className={`font-incognito tracking-wide hover:underline dark:text-green-300 text-green-800`}
          >
            heroe name
          </a>
        </li>
